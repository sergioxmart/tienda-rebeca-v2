...
test('worktree tiene la estructura esperada', () => {
  for (const rel of [
    ...
    'web/server/routes/public/index.js',
    ...
    'web/server/routes/public/index.js',
    'web/server/routes/public/categories.js',
    'web/server/routes/public/attributes.js',
    'web/server/routes/public/products.js',
    'web/server/routes/public/product-detail.js',
    'web/server/routes/public/site-config.js',
    'web/server/routes/public/_helpers.js',
